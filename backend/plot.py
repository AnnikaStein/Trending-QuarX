...
input_path = f'/eos/user/a/anstein/www/Trending_QuarX/full.csv'
...
fig.savefig('/eos/user/a/anstein/www/Trending_QuarX/'+legtitle + '.png', bbox_inches='tight', dpi=900, transparent=True)
